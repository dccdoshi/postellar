...
python gibbs_experimen.py -i 0 -snr 10 25 50 75 -ntemp 10 -order {int(order)} -val "SPIRou{order}_val.df" -output "o{order}" -model "{folder_name}"
""")
